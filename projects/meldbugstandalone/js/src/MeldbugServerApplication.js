...
//@Export('MeldbugServerApplication')
//@Autoload
...
var MeldbugServerApplication = Class.extend(Obj, {
...
bugpack.export('meldbugserver.MeldbugServerApplication', MeldbugServerApplication);
